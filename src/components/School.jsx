    ...
    <div className=" container mx-auto p-8 my-6 flex bg-primary">
      ...
      <div className=" px-4 ">
        ...
        <p className=" text-lg text-black my-2 indent-8">
          <strong>NPS Jalahalli</strong> has a sprawling 8 acres campus with state-of-the-art
        ...
        <p className=" text-lg text-black my-4 indent-8">
          <strong> National Public School Jalahalli </strong> is a progressive child-centric
