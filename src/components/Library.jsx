      ...
      <div className=" min-h-screen flex flex-col">
        ...
        <div className="flex-1 bg-[#f4f5ff] flex relative">
          <div className=" w-full p-4 flex flex-col">
            <div className=" w-full top-[130px] h-[calc(100vh-130px)] lg:py-8 place-items-center lg:pl-0 xl:pl-8">
              <FormBackground />
            </div>
            <div className=" px-3 mt-10">
            <h2 className=" text-3xl lg:text-4xl text-blue font-bold p-4 ">Library</h2>
              <p className=' text-lg font-semibold p-4'>Our school library is a treasure trove of knowledge, offering an extensive collection of books that inspire, educate, and entertain. From timeless classics to modern discoveries, every book on our shelves is a gateway to new ideas and adventures. Step in, explore, and let the power of reading take you places
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 bg-[#f4f5ff] flex relative z-0">
          <div className=" w-2/3 p-4 overflow-y-auto">
            <div className=" px-6 mt-16">
              <h2 className=" text-2xl md:text-3xl lg:text-4xl text-blue font-bold p-8">Library</h2>
              <p className=' text-lg md:text-xl lg:text-2xl font-semibold p-8'>Our school library is a treasure trove of knowledge, offering an extensive collection of books that inspire, educate, and entertain. From timeless classics to modern discoveries, every book on our shelves is a gateway to new ideas and adventures. Step in, explore, and let the power of reading take you places
              </p>
            </div>
