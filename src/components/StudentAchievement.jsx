        ...
        <div className="flex-1 bg-[#5f9ce0] flex relative">
          <div className=" w-full p-4 flex flex-col">
            ...
            <div className=" grid md:grid-cols-2 gap-8">
              ...
              <div className="">
                <img src={achievement5} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement6} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement7} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement8} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement9} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement10} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement11} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement12} alt="activity-img" className=" rounded-lg"/>
              </div>
              <div className="">
                <img src={achievement13} alt="activity-img" className=" rounded-lg"/>
              </div>
            </div>
          </div>
        </div>
